...
public class AppointmentService
{
    ...
    public List<Appointment> findByTeacherIdAndTakenOrderByDate(int teacherId)
    {
        return appointmentRepository.findByTeacherIdAndTakenOrderByDate(teacherId,true);
    }
}